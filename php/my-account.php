...
<head>
  ...
  <script type="module" src="../js/account-search.mjs"></script>
</head>
<body>
      ...
      <header class="main-header">
        ...
        <nav class="nav main-nav">
          <ul>
            ...
            <li><a class="selected" href="login.php">MY ACCOUNT</a></li>
...
<section class="main-section container">
  ...
  <h2 class="section-header">My Uploads</h2>
      <div class="main-patch-container uploads">
      </div>

    <h2 class="section-header">Saved Patches</h2>
